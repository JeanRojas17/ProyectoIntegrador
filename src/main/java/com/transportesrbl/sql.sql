...
INSERT INTO PAQUETE (Id_Cliente, Nro_Paquete, Volumen_m3, Cantidad, Descripcion) VALUES  
(1, 'PKT-001', 5.50, 1, 'Nevera Industrial'),
(2, 'PKT-002', 2.00, 1, 'Envases plásticos'),
(1, 'PKT-003', 1.50, 1, 'Microondas'),
(3, 'PKT-004', 8.20, 1, 'Cajas de gaseosa 1.5L'),
(4, 'PKT-005', 3.10, 1, 'Cajas de medicamentos'),
(5, 'PKT-006', 4.50, 1, 'Lácteos refrigerados'),
(2, 'PKT-007', 6.00, 1, 'Rollos de polietileno'),
(1, 'PKT-008', 1.20, 1, 'Repuestos eléctricos'),
(3, 'PKT-009', 9.50, 1, 'Botellas de agua mineral'),
(5, 'PKT-010', 3.80, 1, 'Yogurt en presentación familiar'),
(4, 'PKT-011', 2.50, 1, 'Insumos médicos'),
(2, 'PKT-012', 4.00, 1, 'Material de empaque corrugado'),
(1, 'PKT-013', 7.50, 1, 'Estufas industriales a gas'),
(3, 'PKT-014', 10.10, 1, 'Bebidas azucaradas no retornables'),
(5, 'PKT-015', 5.00, 1, 'Queso campesino por mayor');

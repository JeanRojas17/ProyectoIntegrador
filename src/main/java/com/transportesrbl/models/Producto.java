...
public class Producto {
    ...
    // Constructor completo de 9 parámetros (necesario para mapear proveedor y cliente)
    ...
    public Producto(int idProducto, String nombre, double volumenUnitario, int cantidad, double volumenTotal, String estado, String destino) {
        this(idProducto, nombre, "Sin Proveedor", "Sin Cliente", volumenUnitario, cantidad, volumenTotal, estado, destino);
    }
